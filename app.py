...
create_table_query = "CREATE TABLE IF NOT EXISTS user_info (ID SERIAL PRIMARY KEY,URL TEXT,words_count INTEGER,sentence_count INTEGER,pos_dict JSON,text text)"
