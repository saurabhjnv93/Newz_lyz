...
create_table_query = "CREATE TABLE IF NOT EXISTS user_info (ID SERIAL PRIMARY KEY,URL VARCHAR(1000000),words_count BIGINT,sentence_count BIGINT,pos_dict VARCHAR(100000),text VARCHAR(10000000))"
